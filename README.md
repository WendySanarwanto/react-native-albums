# react-native-albums
A React Native mobile app sample which demonstrates pulling a list of data from API and display the data as a list of Cards. The sample is taken from Udemy's "The Complete React Native &amp; Redux" course, created by Stephen Grider.
...
* Clone this repository: `git clone https://github.com/WendySanarwanto/react-native-albums.git`
